...
async def connect_to_db(
    ...
    db = DB()
    print(f"Creating read pool with connection string: {readpool}")
    app.state.readpool = await db.create_pool(readpool, settings)
    print(f"Creating write pool with connection string: {writepool}")
...
class DB:
    ...
    def __attrs_post_init__(self):
        print(f"Creating pool with connection string: {self.connection_string}")
